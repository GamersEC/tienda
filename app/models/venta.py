...
class Venta(db.Model):
    ...
    estado = db.Column(db.String(20), nullable=False, default='En Proceso') # En Proceso, Pendiente, Pagada, Anulada, Credito, Con Devolucion
    ...
    frecuencia_cuotas = db.Column(db.String(20), nullable=True)
